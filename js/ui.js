...
/**
 * Displays the names of the selected documents for batch processing.
 * @param {Event} event The file input change event from the doc uploader.
 * @param {HTMLElement} listContainer The <ul> element to display the file names in.
 * @returns {FileList} The list of files selected by the user.
 */
export function handleDocUpload(event, listContainer) {
...
/**
 * Displays a status message for the batch process.
 * @param {string} message The message to display.
 * @param {HTMLElement} statusContainer The DOM element for the status message.
 */
export function updateBatchStatus(message, statusContainer) {
    statusContainer.textContent = message;
}

// --- END: New Batch Mode UI Functions ---
